...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        conv_r_p_out, crp_cache = conv_relu_pool_forward(X, W1, b1,
                                                conv_param, pool_param)
        aff_r_out, ar_cache = affine_relu_forward(conv_r_p_out, W2, b2)
        scores, scores_cache = affine_forward(aff_r_out, W3, b3)
